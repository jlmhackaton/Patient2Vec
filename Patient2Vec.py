...
class Patient2Vec(nn.Module):
    ...
    """
    Firas Notes:
    sub-sequence matrix of size: N x D ...N = num of visits, D = dimension of embedding
    """
    ...
    def __init__(self, input_size, hidden_size, n_layers, att_dim, initrange,
        ...
        :param input_size: int from paper=100 (embedding size)
        :param hidden_size: int def(256)
        :param n_layers: number of layers; int from paper=1?
        :param att_dim: dimension of the attention; int paper=1?
        :param initrange: upper bound of the initial weights; symmetric
        :param output_size: int
        :param rnn_type: str, such as 'GRU'
        :param seq_len: length of the sequence; int paper=4?
        :param pad_size: padding size; int
        :param n_filters: number of hops; int paper =3
